...
def main():
    ...
    # Save metrics JSON
    with open("results/tables/linear_regression_metrics.json", "w", encoding="utf-8") as f:
    ...
    plt.tight_layout()
    plt.savefig("results/figures/lr_actual_vs_pred_test.png", dpi=300)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig("results/figures/lr_residuals_test.png", dpi=300)
    plt.show()
    ...
    try:
        import joblib
        joblib.dump(model, "artifacts/linear_regression_model.joblib")
